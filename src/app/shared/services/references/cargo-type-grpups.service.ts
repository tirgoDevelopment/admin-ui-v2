...
export class CargoTypeGroupsService {
  ...
  getAll(params?: any): Observable<Response<CargoGroupModel[]>> {
    return this.http.get<Response<CargoGroupModel[]>>(env.references + `/references/cargo-type-groups`)
  }
  ...
  delete(id: number | string) { 
    return this.http.delete(env.references + `/references/cargo-type-groups/${id}`)
  }
}